...
**15 秒优化版（Presentation 推荐）：**

| 视频 | 说明 |
|------|------|
| [oasis_15s_optimized.mp4](https://github.com/chenqianwan/Amcc/blob/main/assignment3/demo_outputs/oasis_15s_optimized.mp4) | **分段生成 + 交叉淡入淡出拼接**，8 段 × 50 帧，每段用前一段的好帧作为 prompt，保持视觉连贯性同时避免长序列退化。15 秒 @20fps。 |
| [oasis_15s.mp4](https://github.com/chenqianwan/Amcc/blob/main/assignment3/demo_outputs/oasis_15s.mp4) | **单次连续生成** 300 帧（15 秒），能明显看到后半段记忆衰退导致的画面崩坏。适合展示模型局限性。 |

短版 Demo（1.6 秒，原始 32 帧生成）：
...
| 视频 | 说明 |
|------|------|
| [final_comparison_15s_optimized.mp4](https://github.com/chenqianwan/Amcc/blob/main/assignment3/demo_outputs/final_comparison_15s_optimized.mp4) | **推荐** — 15 秒并排对比（优化版 Oasis vs CogVideoX），带标签 |
| [final_comparison_15s.mp4](https://github.com/chenqianwan/Amcc/blob/main/assignment3/demo_outputs/final_comparison_15s.mp4) | 15 秒并排对比（未优化 Oasis，可看到后半段退化） |
| [side_by_side_comparison.mp4](https://github.com/chenqianwan/Amcc/blob/main/assignment3/demo_outputs/side_by_side_comparison.mp4) | 早期短版并排对比 |
